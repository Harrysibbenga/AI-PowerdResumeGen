<!-- src/components/vue/common/ToastContainer.vue -->
<template>
  <div class="fixed top-4 right-4 z-50 space-y-2">
    <TransitionGroup name="toast" tag="div">
      <div
        ...
        class="flex items-center justify-between p-4 rounded-lg shadow-lg min-w-80 max-w-md"
      >
        <div class="flex items-center">
          <div :class="iconClasses(toast.type)" class="mr-3">
